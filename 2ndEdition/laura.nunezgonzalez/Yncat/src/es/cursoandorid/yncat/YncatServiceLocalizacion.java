...
public class YncatServiceLocalizacion extends Service{
	...
	public void onStart(Intent intent, int startId) {
		...
		mHandler = YncatMapsActivity.mHandler;
		mDist = (float) 0;
	...
	private class MyLocationListener implements LocationListener
	{
		...
		public void onLocationChanged(Location location) {
			...
			data.putDouble(YncatConstants.LATITUDE, location.getLatitude());
			data.putDouble(YncatConstants.LONGITUDE, location.getLongitude());
			msg.setData(data);
