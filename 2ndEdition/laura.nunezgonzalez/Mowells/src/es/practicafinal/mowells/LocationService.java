...
public class LocationService extends Service {
	...
	public LocationService(){
		...
		this.mHandler = MapsActivity.mHandler;
		setLocationListener();
	}
	...
	private void setLocationListener() {
		Log.d("LISTENER", "ESto tiene la variable: " + Context.LOCATION_SERVICE);
		...
		Log.d("LISTENER", "Despues de declarar variables y tal pascual");
